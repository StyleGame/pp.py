...
des = """\x1b[0;32mWelcome To Script Vodafone 200 MB  """
print(des)
print()
number = input(" \x1b[0;33mEnter your number: ").strip()
print()
...
json={"channelId": 3, "contextualOperationId": 0, "contextualPromoId": 0, "operationId": 0, "param1": "M2ue997G", "promoId": 3336, "triggerId": 332, "triggerType": "6", "wlistId": 3256}
...
if g == "200":
	...
	print("جرب مره اخره بعد 24 ساعه")
